...
import { Upload, Download, Filter, Settings2, List, Search, Plus, Trash2, CheckSquare, Square, ArrowRight, BookOpen, GraduationCap, CheckCircle, RotateCcw, FileDown, ChevronDown } from 'lucide-react';
                                ...
                                <div className="absolute top-full right-0 mt-1 w-64 bg-white rounded-xl shadow-2xl border border-slate-100 py-2 z-50 animate-in fade-in slide-in-from-top-2 duration-200">
                                    ...
                                    >
                                        ...
                                        <div className="flex flex-col text-left">
                                            ...
                                            <span className="text-[10px] text-slate-400 leading-relaxed mt-0.5">获取标准 JSON 格式，可配合 AI 批量生成数据。</span>
                                        </div>
                                    </button>
                                </div>
                            )}
